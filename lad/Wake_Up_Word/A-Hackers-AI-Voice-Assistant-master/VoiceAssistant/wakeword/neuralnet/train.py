...
#     required=True, help='path to train data json file')
...
if __name__ == "__main__":
    ...
    arguments = Args(save_checkpoint_path='./scripts/data/checkpoint',
                     train_data_json='./scripts/data/jsons/train.json',
                     test_data_json='./scripts/data/jsons/test.json',
                     no_cuda=True,
                     sample_rate=16000)
