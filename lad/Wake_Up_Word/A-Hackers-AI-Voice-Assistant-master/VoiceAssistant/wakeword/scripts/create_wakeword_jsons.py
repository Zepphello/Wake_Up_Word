...
class Args:
    def __init__(self,
                 zero_label_dir: str = None,
                 one_label_dir: str = None,
                 save_json_path: str = None,
                 percent: int = 10):
        self.zero_label_dir = zero_label_dir
        self.one_label_dir = one_label_dir
...
if __name__ == "__main__":
    ...
    arguments = Args(zero_label_dir='./scripts/data/0', one_label_dir='./scripts/data/1',
                     save_json_path='./scripts/data/jsons', percent=20)
