...
def interactive(args):
    ...
    try:
        while True:
            ...
            frames = []
            # input('press enter to continue. the recoding will be {}
            # seconds. press ctrl + c to exit'.format(args.seconds))
...
class Args:
    def __init__(self,
                 ...
                 seconds: int = None,
                 save_path: str = None,
                 interactive_save_path: str = None,
                 interactive: bool = False):
        self.sample_rate = sample_rate
        self.seconds = seconds
        self.save_path = save_path
        self.interactive_save_path = interactive_save_path
...
arguments = Args(sample_rate=8000, seconds=2, save_path='./data/wakeword/sound.wav',
                 interactive=True, interactive_save_path='./data/wakewords')
